...
class PremitURRAScreen(tk.Frame):
    ...
    def create_widgets(self):
        ...
        # Title Label
        title_label = ttk.Label(main_frame, text="Pre-Mitigated URRA Formatting", font=("Arial", 16, "bold"))
    ...
    def generate(self):
        ...
        try:
            ...
            if not all([header_row, first_parent_col, second_parent_col, harm_id_col, 
                       occurrence_col, severity_col, risk_analysis_col, output_filename]):
