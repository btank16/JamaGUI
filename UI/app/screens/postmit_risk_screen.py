...
class PostmitRiskScreen(tk.Frame):
    ...
    def create_widgets(self):
        ...
        # Title Label
        title_label = ttk.Label(main_frame, text="Post-Mitigated dFMEA Formatting", font=("Arial", 16, "bold"))
    ...
    def generate(self):
        ...
        try:
            ...
            if not all([header_row, harm_id_col, severity_col, pre_occurrence_col, pre_risk_analysis_col,
